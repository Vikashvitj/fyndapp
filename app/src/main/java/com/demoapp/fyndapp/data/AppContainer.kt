package com.demoapp.fyndapp.data

import android.app.Application
import com.demoapp.fyndapp.data.db.AppDatabase
import com.demoapp.fyndapp.data.network.HttpInterceptor
import com.demoapp.fyndapp.data.network.TMDBService
import okhttp3.OkHttpClient
import com.demoapp.fyndapp.BuildConfig
...
class AppContainer(context: Application) {
    ...
    val iTunesApiService by lazy {
        TMDBService.create(getOkHttpClient())
    }
